...
// Esc triggers UPPER on hold (moved from Backspace)
#define ESC_UPP   LT(_UPPER, KC_ESC)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    // ───────────── BASE ─────────────
    // Swap positions: top-right is Backspace, thumb key is Esc (hold = UPPER)
