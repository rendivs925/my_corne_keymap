...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LOWER] = LAYOUT_split_3x6_3(
        ...
        KC_LCTL, KC_PLUS, KC_MINS, KC_EQL, KC_ASTR, KC_TILD,
    ...
    [_UPPER] = LAYOUT_split_3x6_3(
        CTRL_TAB, KC_LALT(KC_1), KC_LALT(KC_2), KC_LALT(KC_3), KC_LALT(KC_4), KC_LALT(KC_5),
                   PREV_DIAG, NEXT_DIAG, CTRL_ALT_B, CTRL_ALT_F, CTRL_ALT_T, TERM_CLEAR,

        CTRL_SHIFT_TAB, KC_LALT(KC_6), KC_LALT(KC_7), KC_LALT(KC_8), KC_LALT(KC_9), KC_LALT(KC_0),
                         KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, VIM_WRITE, VIM_QUIT,

        CTRL_ALT_A, CTRL_ALT_E, CTRL_ALT_W, CTRL_SHIFT_C, CTRL_SHIFT_V, CTRL_SHIFT_LBRC,
